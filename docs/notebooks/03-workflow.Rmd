...
When creating a package, the source code location (path) refers to where the __source__ lives, not where the __installed__ form lives. Recall in the [introduction notebook](https://misk-data-science.github.io/misk-packages/notebooks/01-introduction.html) that installed packages all live within a library directory. But when developing, you will keep the source code somewhere else. 
