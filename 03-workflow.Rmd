...
package_short_description [myfirstpkg provides... (one line)]: myfirstpkg provides simple helper functions to help me learn packaging
version [0.1.0]: 
...
package_short_description [myfirstpypkg provides... (one line)]: myfirstpypkg provides simple helper functions to help me learn packaging
version [0.1.0]: 
