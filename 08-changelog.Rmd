...
1. Go to your `r fontawesome::fa("r-project")` and/or `r fontawesome::fa("python")` package and check out the existing changelog.
2. Add appropriate sections within the current version you are working to capture the features __added__ and any other changes you have made.
