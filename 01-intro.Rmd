...
- __To share with others__: Bundling your code into a package makes it easy for other people to use it, because like you, they already know how to use packages. If your code is in a package, any R or Python user can easily download it, install it and learn how to use it.
...
- __Small scripts__: Sometimes a simple R, Python, or Bash script can go a long way and serve your primary purpose. Small individual scripts can be easy to build, execute and orchestrate; however, if you notice this small script starting to grow in size and use then it's time to start thinking of converting it to a package.
...
| Assumptions                       | Python Resource | R   Resource   
| --------------------------------- | ------------- | ------------- |
...
- R: [Creating R Extensions](https://cran.r-project.org/doc/manuals/R-exts.html#Creating-R-packages)
